...
bot = telebot.TeleBot('7504113218:AAEHeUXsFxvijW-96gZwPLymy90UgiDyXso')

# Admin user IDs
admin_id = ["6948215732","1640551343","1747632070"]
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 987355:
                response = "Error: Time interval must be less than 987622."
            else:
